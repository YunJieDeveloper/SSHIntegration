...
public class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    public Serializable save(T entity) {
        ...
        Serializable t = session.save(entity);
        return t;
    ...
    /**
     * 当通过 sessionFactory.getCurrentSession()获取session时不需要调用此方法；
     * 当通过 sessionFactory.openSession()获取session时则需要调用此方法手动关闭Session。
     * */
