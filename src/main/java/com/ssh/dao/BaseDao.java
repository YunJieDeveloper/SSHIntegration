...
import com.ssh.handler.HibernateHandler;
import com.ssh.utils.Pagination;
...
public interface BaseDao<T> {
     ...
     */
    @SuppressWarnings("hiding")
     <T> Pagination<T> findSqlPagination(final CharSequence queryString, final CharSequence countString,
     ...
     * @return 实体列表
     */
     <V> List<V> findListByMax(CharSequence queryString, int maxResults, Object... params);
     ...
     * @return 实体列表
     */
     <V> List<V> findListByMax(CharSequence queryString, int maxResults, Map<String, Object> params);
}
